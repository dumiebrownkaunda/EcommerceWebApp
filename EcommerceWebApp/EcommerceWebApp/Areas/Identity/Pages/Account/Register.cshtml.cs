        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(SD.StockUser))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(SD.StockUser));
                    ...
                    if (role ==SD.StockUser)
                    {
                        await _userManager.AddToRoleAsync(user, SD.StockUser);
